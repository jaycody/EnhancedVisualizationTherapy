...
Mover [] movers = new Mover [10];  //yeah buddy, get with those arrays!!

Attractor [] attractors = new Attractor [7];
...
void setup() {
  ...
  // arguments: Loc, mass, Gravitation constant "G"
...
void draw () {
  ...
  // and for each attractor to be attracted to each other??
}
