...
/*
 ...
 To Use: 
 -PROCESSING 2.0
 -second screen aligned with the top of the main screen
 -adjust ComputerScreenXRes for the X-axis resolution of you main computer
 ...
 -Drag the top/larger mesh surface 'til it fills the projection area.
 -Using an RGB view from the Kinect, in the camera view drag the
 ...
 -'l' blows wind' to blow particles to the left.
...
//----------------------------------Draw
void draw() {
  frame.setLocation(computerScreenXRes-CXRes, 0);//original::frame.setLocation(1680-CXRes, 0);
