/*jason stephens
thesis - ITP
EV_Therapy - EV_FlowFieldAutomata
...
int CellSize = 5;
int CellsAcross = 161; //approximating the golden ratio
int CellsDown = 100;
int BrushSize = 2;
int BrushStrength = 35;
 
int Calm = 400; //original 233      //add control mechanism here <---
...
void setup() {
  ...
  size(CellsAcross * CellSize, CellsDown * CellSize);       // should = (CellsAcross * CellSize, CellsDown * CellSize);
