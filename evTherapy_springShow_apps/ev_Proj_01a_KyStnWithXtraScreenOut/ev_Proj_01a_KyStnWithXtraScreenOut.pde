...
void setup() {
  ...
  canvasKeystoned = new GLGraphicsOffScreen(this, 640, 480);//was set to width, height.  now set to kinect 

  ks = new Keystone(this);
  surface = ks.createCornerPinSurface(640, 480, 20); //was set to width and height.  now set to kinect
