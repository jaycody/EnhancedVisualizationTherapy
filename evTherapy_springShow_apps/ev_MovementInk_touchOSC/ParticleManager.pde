...
class ParticleManager {
  ...
  int noiseStrength = 3;//3;//340;//30;//10; // cloud variation, 
  ...
  int noiseScale = 5;//5 (on may 6 evtherpy);//original 10 but try 4000;//200;//100; //200; // cloud strength multiplier, 
  ...
  int forceMultiplier = 5;//20;//100;//35;//90;//50;//20;//50;//10;//300; // force to apply to input - mouse, touch etc.
  ...
  int generateSpread = 25;//---------------------------25;//15;//25;//2;//5;//10;//10; // offset for particles emitted
